...
{
    int tx=ui->textEdit_2->toPlainText().toInt();
    int ty=ui->textEdit_3->toPlainText().toInt();
    paint.begin((&pic));
    draw();
    int i=0;
...
{
    int sx=ui->textEdit_2->toPlainText().toInt();
    int sy=ui->textEdit_3->toPlainText().toInt();
    paint.begin((&pic));
    draw();
    int i=0;
    for(i=0;i<numPoints-1;i++)  //x_co=x*1+y*0
